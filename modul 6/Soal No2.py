...
def tampilkan_peminjaman():
    if not data_peminjaman: # not ini berguna jika tidak menginputkan salah satu persyaratan peminjaman 
...
def perbarui_peminjaman():
    ...
    for i, peminjaman in enumerate(data_peminjaman):   # berfungsi memberikan indeks 0,1,2,dst
