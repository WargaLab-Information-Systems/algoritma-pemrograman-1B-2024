...
# alat_kesehatan["Pengukur Kadar Gula Darah"] += 4

# alat_kesehatan["Pengukur Tekanan Darah"] -= 1
# alat_kesehatan["Termometer"] -= 2

# alat_kesehatan["Pengukur Tekanan Darah"] -= 3
# alat_kesehatan["Pengukur Tensi"] += 2

# print("Alat yang Dipinjam Saat Ini Adalah : ")
